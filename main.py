...
class WordCloudPlugin(Star):
    ...
    async def today_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "今日", group_key):
            yield result
    ...
    async def yesterday_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "昨日", group_key):
            yield result
    ...
    async def week_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "本周", group_key):
            yield result
    ...
    async def last_week_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "上周", group_key):
            yield result
    ...
    async def month_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "本月", group_key):
            yield result
    ...
    async def last_month_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "上月", group_key):
            yield result
    ...
    async def year_wordcloud(self, event: AstrMessageEvent):
        ...
        async for result in self._send_wordcloud_direct(event, messages, "今年", group_key):
            yield result
    ...
    async def noun_wordcloud(self, event: AstrMessageEvent):
        ...
        group_id = event.message_obj.group_id or None
        messages = await self._get_messages(event, "today", group_id)
        async for result in self._send_wordcloud_direct(
